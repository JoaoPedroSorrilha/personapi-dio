...
class PersonControllerTest {
    ...
    @Test
    void testWhenPOSTIsCalledThenApersonhouldBeCreated() throws Exception {
        PersonDTO expectedPersonDTO = createFakeDTO();
        MessageResponseDTO expectedResponseMessage = createMessageResponse("Pessoa criada como o ID", 1L);
    ...
    @Test
    void testWhenGETWithValidIsCalledThenApersonhouldBeReturned() throws Exception {
    ...
    @Test
    void testWhenPUTIsCalledThenApersonhouldBeUpdated() throws Exception {
        var expectedValidId = 1L;
        PersonDTO expectedPersonDTO = createFakeDTO();
    ...
    @Test
    void testWhenDELETEIsCalledThenApersonhouldBeDeleted() throws Exception {
        var expectedValidId = 1L;
